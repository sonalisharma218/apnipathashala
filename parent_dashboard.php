...
<body>
	<div id="wrapper">
		...
		<div id="content">
			...
			<div id="view_port">
				<div id="menu_box"><p><font size="6" color="white" style="margin-left: 12px; line-height: 48px; float: left;"><b>Parent Dashboard</b></font></p><i class="login_as">Login As : <?php echo $_SESSION['name']?></i></div>
