...
<html>
	...
	<div id="content">
		...
		<div class="login_form">
			<font size="6"><b>Parent Login</b></font><br>
			...
			<input type="submit" name="" value="Login" class="button" id="parent_login"><br><br>
			<span><a href="forget_password.php">Forget Password</a></span><br><br>
			<font color="white" size="4">Are you new user?</font><font><br><br><a href="parent_reg.php">Signup</a></font>
		</div>
		</center>
	</div>
	<div id="footer">
	...
	$(function() {
		$("#parent_login").click(function(){
			...
			if (username=="") {
				...
				$.get("login.php",{uid:$("#uid").val(),pwd:$("#pwd").val(),parent_login:$("#parent_login").val()},function(data){
					if(data=="parent_dashboard.php") {
