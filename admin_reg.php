...
<html>
	...
	<div id="content">
		<div id="floated_form"><br><br>
			...
			<center><font size="7" class="heading"><b><h2>Admin Registration</h2></b></font></center>
			...
			<div class="column">
				...
				<div class="column">
					...
					<div id="column">
						...
						<textarea placeholder="Address" name="address" id="adr"></textarea><br>
	...
	$(function(){
		...
		$("#submit").click(function(){
			...
			if (name=="") {
				...
				$.get("crud_admin_reg.php",{a_name:name,a_mobile:mobile,a_education:education,a_mail:mail,a_password:password,a_address:address,submit:submit},function(data){
