	...
	<body>
		<div id="wrapper">
			...
			<div id="content" style="background-color: none;">
				...
				<div id="view_port">
					<div id="menu_box"><p><font size="6" color="white" style="line-height: 48px; float: left;"><b>List of Director</b></font></p>
...
<form action="#" method="post" onsubmit="return false">
	...
	<div class="column" style="height: 100px;">
		...
		<input type="text" name="director_name" class="input_box" placeholder="Full Name." id="dname">
		<br><br>
		<font size="4" class="font">school Name:-</font><br>
		<input type="text" name="school_name" class="input_box" placeholder="Full Name." id="sname">
		<br><br>
...
<script type="text/javascript">
	$(function(){
		...
		/// Searchbox get started ///
		$("#search").keyup(function(){
			search = $(this).val();
			$.get("cruid_directorlist.php",{search:search},function(data){
				$("#viewdata").html(data);
			})
		})
		/// Searchbox get ended ///
		$("#submit").click(function(){
			...
			if (name=="") {
				...
				$("#adr").focus();
				  ...
				  $.get("crud_directorlist.php",{dname:name,dschool:school,dmobile:mobile,demail:email,dpassword:password,daddress:address,submit:submit},function(data){
					  $("#viewdata").html(data);
